...
$tests = @(
  ...
  "tb_load_base_from_early_exmem",
  "tb_load_mul_forward_boundary",
  "tb_load_mul_slow_one_stall",
  ...
  "tb_csr_counter",
  "tb_branch_predictor",
  "tb_branch_predictor_init_taken",
  "tb_prefetch",
  "tb_mem_pipeline",
  "tb_dmem_loader_rv64",
  ...
  "tb_uart_loader",
  "tb_multiplier",
  "tb_multiplier_back_to_back",
  "tb_uart_rx",
  "tb_uart_tx",
  "tb_mul",
  "tb_mul_pipeline_back_to_back",
  "tb_mul_result_forward_early",
  "tb_mul_result_no_early_forward",
  "tb_mul_nonblocking",
  "tb_div",
  "tb_rv64i_basic",
  "tb_rv64m_basic",
  "tb_rv64m_slow_mul_pipeline",
  "tb_soc_uart_hello",
