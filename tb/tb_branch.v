...
module tb_branch;
    ...
    initial begin
        ...
        if ((debug_dmem_word3 == 32'd7) && (debug_dmem_word1 == 32'd1)) begin
            $display("PASS branch regression completed");
            $finish;
        end

        $display("FAIL branch: word3=%08x word1=%08x", debug_dmem_word3, debug_dmem_word1);
        $finish;
    end
endmodule
