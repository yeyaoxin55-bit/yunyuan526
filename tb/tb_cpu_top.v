...
module tb_cpu_top;
    ...
    cpu_top #(
        ...
        .IMEM_DEPTH(256),
        .DMEM_DEPTH(256),
        .IMEM_INIT_FILE("tb/programs/smoke.hex"),
        .DMEM_INIT_FILE("")
    ) dut (
        .clk(clk),
        .rst(rst),
    ...
    initial begin
        ...
        if ((debug_dmem_word0 == 32'd12) && (debug_dmem_word1 == 32'd1)) begin
            $display("PASS smoke program completed");
            $finish;
        end

        $display("FAIL smoke program: word0=%08x word1=%08x", debug_dmem_word0, debug_dmem_word1);
        $finish;
    end
endmodule
